...
### Client Management (Customers & Suppliers)
...
- `GET /workspaces/${OPCIFY_WORKSPACE_ID}/clients/:id` — Get client details
...
Use summarize to condense information before responding to the store owner.
