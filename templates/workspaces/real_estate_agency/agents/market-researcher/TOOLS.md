...
Use web-search for researching property data from Australian sources (CoreLogic, Domain, REA, ABS, RBA).
Use summarize for condensing market data into key findings.
