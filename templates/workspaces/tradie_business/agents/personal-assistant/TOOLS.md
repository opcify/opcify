...
- `POST /workspaces/${OPCIFY_WORKSPACE_ID}/tasks` — Create new tasks (jobs, follow-ups, invoices, reviews)
...
Use summarize to condense information before responding to the tradie.
