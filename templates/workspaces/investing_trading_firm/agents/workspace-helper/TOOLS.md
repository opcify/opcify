...
## Market Data API Token Environment Variables

These can be set via the openclaw config to enable market data integrations:

- `ALPHA_VANTAGE_API_KEY` — Alpha Vantage market data API
- `POLYGON_API_KEY` — Polygon.io real-time and historical data
- `FINNHUB_API_KEY` — Finnhub financial data API
